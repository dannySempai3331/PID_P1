...
def getCoordenadas():
    ...
    #verificar si el panel de la imagen tiene una imagen
    if panel_imagen.winfo_ismapped():

        #verificar si los campos de las coordenadas estan vacios
...
def abrirImagen():
    ...
    labelDimImg.config(text= str(ancho) + " x " + str(alto))
...
labelDimImg = tk.Label(frame_mid, text="-", font=("Consolas", 10))
labelDimImg.pack()
...
buttonIniciar = tk.Button(frame_bottom, text="Iniciar", font=("Consolas", 10), bg="green", fg="white", command=getCoordenadas)
